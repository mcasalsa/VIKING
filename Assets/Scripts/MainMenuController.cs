...
public class MainMenuController : MonoBehaviour {
    ...
    public GameObject LoadInstructionsPanel;
    ...
    // controls volum i resolució.

    // Volum general
    public void SetMsaterVolumen(float value)
    {
    ...
    // Resolució.
    public void SetFullScreen(bool isFullScrreen)
    {
    }
    ...
    public void openOptions_Game()
    {
        ...
        LoadInstructionsPanel.SetActive(false);
...
public void loadInstructionsPanel()
    {
        ...
        GfxPanel.SetActive(false);
        LoadGamePanel.SetActive(false);
        LoadInstructionsPanel.SetActive(true);
    ...
    public void newGame()
    {
        if (!string.IsNullOrEmpty("Phase_A"))
